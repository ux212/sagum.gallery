...
export const MusicAndMovieData = {
  ...
  works: [
    { name: "소원", img: Wish, form: "(500mm x 500mm), 그래픽 인쇄" },
    { name: "Forgot U", img: ForgotU, form: "(500mm x 500mm), 그래픽 인쇄" },
    { name: "낙하", img: Fall, form: "(500mm x 500mm), 그래픽 인쇄" },
    { name: "발할라", img: Valhalla, form: "(500mm x 500mm), 그래픽 인쇄" },
    { name: "망상", img: Delusion, form: "(800mm x 500mm), 프로젝터로 맵핑" },
  ],
};
